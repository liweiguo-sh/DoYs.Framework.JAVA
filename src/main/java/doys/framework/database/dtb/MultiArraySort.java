...
public class MultiArraySort implements Comparator<Object> {
    ...
    public MultiArraySort(String[][] arrCols) {
        this._arrCols = arrCols;
        _collator = (RuleBasedCollator) Collator.getInstance(Locale.CHINA);
    }
    public MultiArraySort(String[][] arrCols, boolean SortByChinese) {
        this._arrCols = arrCols;
        _collator = (RuleBasedCollator) Collator.getInstance(Locale.CHINA);
        _SortByChinese = SortByChinese;
    }
    public MultiArraySort(String[][] arrCols, boolean SortByChinese, boolean NullIsMaxValue) {
        this._arrCols = arrCols;
        _collator = (RuleBasedCollator) Collator.getInstance(Locale.CHINA);
        _SortByChinese = SortByChinese;
    ...
    public int compare(Object o1, Object o2) {
        ...
        for (int i = 0; i < _arrCols.length; i++) {
            ...
            String bValue = ((String[]) o2)[colIndex];
            // --null值特殊处理-----------------------------------------------------
